...
export const presets = [
    ...
    settings: [
      {
        ...
        "note_colors": ["#fafafa", "#ffe5e5", "#c8d0c8", "#c8c8d0", "#fff7d6", "#fafafa", "#ffe5e5", "#c8d0c8", "#c8c8d0", "#fff7d6", "#fafafa", "#c8c8d0", "#c8d0c8", "#fafafa", "#ffe5e5", "#c8d0c8", "#c8c8d0", "#fff7d6", "#fafafa", "#ffe5e5", "#c8d0c8", "#c8c8d0", "#fff7d6", "#fafafa", "#ffe5e5", "#c8d0c8", "#c8c8d0", "#fff7d6", "#fafafa", "#c8c8d0", "#c8d0c8", "#fafafa"],
        "equivSteps": 31,
        "key_labels": "names",
        "spectrum_colors": false,
        "rSteps": 5,
  ...
  },
  {
    ...
    settings: [
      ...
      {
        "name": "12-JI-7L Jankó",
        "description": "12-JI-7L Jankó: 12-tone Just Intonation 7-Limit scale, consisting of 12 rational divisions per frequency halving/doubling with sonic distances derived from the harmonic series up to a prime limit of 7, mapped on a tilted Jankó layout which can be regarded as a stacked 6-6/Balanced/Symmetric/Bilinear/Uniform Keyboard, and which approximates the 7-white/5-black Halberstadt organ layout.",
      ...
      },
      {
        ...
        "note_colors": ["#fafafa", "#c8d0c8", "#c8c8d0", "#fafafa", "#c8d0c8", "#c8c8d0", "#fafafa", "#fafafa", "#c8d0c8", "#c8c8d0", "#fafafa", "#c8d0c8", "#c8c8d0", "#fafafa", "#c8d0c8", "#c8c8d0", "#fafafa"],
        "equivSteps": 17,
        "key_labels": "names",
        "spectrum_colors": false,
        "rSteps": 3,
      ...
      },
      {
        ...
        "description": "22-JI-5L-Indian 22-tone scale: 5-Limit Just Intonation which is schismatic equivalent to a 22-tone 3-Limit scale generated from 11 steps ascending and 10 descending plus the fundamental, consisting of 22 rational divisions per frequency halving/doubling with sonic distances derived from the harmonic series up to a prime limit of 5, notated after Alain Daniélou, mapped on a Bosanquet / Wilson / Terpstra layout.",        
