  ...
  <>
    ...
    <label>
      ...
      <select value={props.settings.midi_mapping}
        ...
        <option value="multichannel">multichannel, each cycle wraps around MIDI degree0</option>
        <option value="sequential">all notes on selected channel, around MIDI degree0</option>
